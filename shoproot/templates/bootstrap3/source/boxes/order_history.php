  ...
  if (isset($_SESSION['customer_id'])) {
    ...
    if (xtc_db_num_rows($orders_query) > 0) {
      while ($orders = xtc_db_fetch_array($orders_query)) {
        $customer_orders_array[] = array(
          'PRODUCTS_LINK' => '<a class="btn btn-default" href="' . xtc_href_link(FILENAME_PRODUCT_INFO, 'products_id='.$orders['products_id']) . '" style="white-space:normal;">' . $orders['products_name'] . '</a>',
