...
if (!$box_smarty->is_cached(CURRENT_TEMPLATE.'/boxes/box_login.html', $cache_id) || !$cache) {
  ...
  if (!isset($_SESSION['customer_id'])) {
    ...
    $box_smarty->assign('FIELD_EMAIL', xtc_draw_input_field('email_address', '', 'class="form-control input-sm"'));
    $box_smarty->assign('FIELD_PWD', xtc_draw_password_field('password', '', 'class="form-control input-sm"'));
