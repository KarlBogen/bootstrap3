<?php
/* -----------------------------------------------------------------------------------------
   $Id: boxes.php 12420 2019-11-21 14:16:27Z Markus $
...
$fullcontent = array(FILENAME_CHECKOUT_SHIPPING,
	...
	if (PROD_DETAIL_FULLCONTENT === true) $fullcontent[] = FILENAME_PRODUCT_INFO;
...
// -----------------------------------------------------------------------------------------
  ...
  // Produktlisten Fullcontent (sollen die Produktansichten fullcontent sein, einfach die beiden "//" in den n䣨sten 3 Zeilen entfernen)
