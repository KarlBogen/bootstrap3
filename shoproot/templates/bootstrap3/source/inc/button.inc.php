...
function get_bootstrap_button($image, $alt = '', $parameters = '', $submit = false) {
    ...
    // Erkl䲵ng: es wird gepr?ft, welches Buttonbild von Modified aufgerufen wird. Dementsprechend werden neue Attribute zugewiesen.
    ...
    //      'Class' => '' (hier kann dem Button noch eine zus䴺liche CSS-Klasse zugewiesen werden).
    /* Buttons array */
    $buttons = array(
    // PayPal
